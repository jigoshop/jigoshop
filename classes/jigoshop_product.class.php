...
class jigoshop_product extends Jigoshop_Base {
	...
	public function is_shipping_taxable() {
		return ( $this->tax_status == 'taxable' || $this->tax_status == 'shipping' );
	}
	 ...
	 * @return  bool
	 */
	public function has_enough_stock( $quantity, $variation_id = '' ) {
		...
		$temp = ( empty ( $variation_id ) )
			? new jigoshop_product( $this->ID )
			: new jigoshop_product_variation( $variation_id );
