...
//	global $options_settings; // TODO: replace this throughout
	...
	protected function __construct() {
		...
		$current_options = get_option( 'jigoshop_options' );
	...
	public function get_current_options() {
		if ( empty( self::$current_options )) {
			...
			else self::$current_options = self::$default_options;
		}
	...
	protected function set_current_options( $options ) {
		...
		update_option( 'jigoshop_options', $options );
	}
	...
	protected function set_default_options() {
		...
		self::$default_options = array(
			...
			array( 'type' => 'heading', 'name' => __('Pages', 'jigoshop') ),
			...
			array( 'type' 		=> 'heading', 'name' => __('Catalog &amp; Pricing', 'jigoshop') ),
			...
			array( 'type' => 'heading', 'name' => __('Images', 'jigoshop') ),
		
			array( 'name' => __('Image Options', 'jigoshop'), 'type' => 'title','desc' => __('Large variations from the defaults could require CSS modifications in your Theme.','jigoshop') ),
			...
			array( 'type' => 'heading', 'name' => __('Coupons', 'jigoshop') ),
			...
			array( 'type' => 'heading', 'name' => __('Products &amp; Inventory', 'jigoshop') ),
			...
			array( 'type' => 'heading', 'name' => __('Shipping', 'jigoshop') ),
			...
			array( 'type' => 'heading', 'name' => __('Tax', 'jigoshop') ),
			...
			array( 'type' => 'heading', 'name' => __('Payment Gateways', 'jigoshop') ),
