...
class paypal extends jigoshop_payment_gateway {
    ...
    public function process_admin_options() {
   		...
   		if(isset($_POST['jigoshop_paypal_testmode'])) update_option('jigoshop_paypal_testmode', 'yes'); else update_option('jigoshop_paypal_testmode', 'no');
   		if(isset($_POST['jigoshop_paypal_send_shipping'])) update_option('jigoshop_paypal_send_shipping', 'yes'); else update_option('jigoshop_paypal_send_shipping', 'no');
        if(isset($_POST['jigoshop_paypal_force_payment'])) update_option('jigoshop_paypal_force_payment', 'yes'); else update_option('jigoshop_paypal_force_payment', 'no');
    }
