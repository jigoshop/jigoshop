...
class jigoshop_bank_transfer extends jigoshop_payment_gateway {
	...
	public function __construct() {
		...
		$this->enabled			= Jigoshop_Base_Class::get_options()->get_option('jigoshop_bank_transfer_enabled');
		$this->title 			= Jigoshop_Base_Class::get_options()->get_option('jigoshop_bank_transfer_title');
		$this->description 		= Jigoshop_Base_Class::get_options()->get_option('jigoshop_bank_transfer_description');
		$this->bank_name 		= Jigoshop_Base_Class::get_options()->get_option('jigoshop_bank_transfer_bank_name');
		$this->acc_number 		= Jigoshop_Base_Class::get_options()->get_option('jigoshop_bank_transfer_acc_number');
		$this->sort_code 		= Jigoshop_Base_Class::get_options()->get_option('jigoshop_bank_transfer_sort_code');
		$this->iban 			= Jigoshop_Base_Class::get_options()->get_option('jigoshop_bank_transfer_iban');
		$this->bic 				= Jigoshop_Base_Class::get_options()->get_option('jigoshop_bank_transfer_bic');
		$this->additional 		= Jigoshop_Base_Class::get_options()->get_option('jigoshop_bank_transfer_additional');
