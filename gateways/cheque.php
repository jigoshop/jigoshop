...
class jigoshop_cheque extends jigoshop_payment_gateway {
	...
	public function admin_options() {
	    ...
	    <tr>
	        <th scope="row"><a href="#" data-rel="tooltip" title="<?php _e('Let the customer know the payee and where they should be sending the cheque too and that their order won\'t be shipping until you receive it.','jigoshop') ?>" class="tips" tabindex="99"></a><?php _e('Customer Message', 'jigoshop') ?></th>
	        <td class="forminp">
