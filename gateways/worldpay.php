 ...
 **/
function jigoshop_add_worldpay_gateway( $methods ) {
	$methods[] = 'jigoshop_worldpay';
	return $methods;
}
add_filter( 'jigoshop_payment_gateways', 'jigoshop_add_worldpay_gateway', 3 );
...
class jigoshop_worldpay extends jigoshop_payment_gateway {
	...
	private static $allowed_currencies = array(
		...
		'CAD' => 'CAD', 'CLP' => 'CLP', 'CLP' => 'CLP', 'CHF' => 'CHF', 'COP' => 'COP',
		'CZK' => 'CZK', 'VND' => 'VND', 'AED' => 'AED', 'DKK' => 'DKK', 'HUF' => 'HUF',
		'HKD' => 'HKD', 'HRK' => 'HRK', 'JOD' => 'JOD', 'KES' => 'KES', 'KWD' => 'KWD',
		'EEK' => 'EEK', 'ROL' => 'ROL', 'MTL' => 'MTL', 'LVL' => 'LVL', 'LTL' => 'LTL',
		'MXN' => 'MXN', 'MXP' => 'MXP', 'ANG' => 'ANG', 'ILS' => 'ILS', 'NOK' => 'NOK',
		'TWD' => 'TWD', 'NZD' => 'NZD', 'PHP' => 'PHP', 'PLN' => 'PLN', 'QAR' => 'QAR',
		'BRL' => 'BRL', 'RUB' => 'RUB', 'ZAR' => 'ZAR', 'MYR' => 'MYR', 'OMR' => 'OMR',
		'RON' => 'RON', 'IDR' => 'IDR', 'INR' => 'INR', 'PKR' => 'PKR', 'SGD' => 'SGD',
