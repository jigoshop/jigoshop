...
class dibs extends jigoshop_payment_gateway {
	...
	**/
	public function admin_options() {
		...
		$options = array (
			...
			array( 'name'        => __('DIBS FlexWin', 'jigoshop'), 'type' => 'title', 'desc' => __('DIBS FlexWin works by sending the user to <a href="http://www.dibspayment.com/">DIBS</a> to enter their payment information.', 'jigoshop') ),
	...
	**/
	public function process_admin_options() {
		if(isset($_POST['jigoshop_dibs_enabled'])) update_option('jigoshop_dibs_enabled', 'yes'); else update_option('jigoshop_dibs_enabled', 'no');
		...
		if(isset($_POST['jigoshop_dibs_testmode'])) update_option('jigoshop_dibs_testmode', 'yes'); else update_option('jigoshop_dibs_testmode', 'no');
	}
