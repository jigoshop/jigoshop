...
class skrill extends jigoshop_payment_gateway {
	...
	public function __construct() {
		...
		$js_options->add_option('jigoshop_skrill_enabled', 'yes');
		$js_options->add_option('jigoshop_skrill_email', '');
		$js_options->add_option('jigoshop_skrill_title', 'skrill');
		
        $this->id			= 'skrill';
        $this->title 		= 'Skrill';
        $this->icon 		= jigoshop::assets_url() . '/assets/images/icons/skrill.png';
        $this->has_fields 	= false;
      	$this->enabled		= $js_options->get_option('jigoshop_skrill_enabled');
		$this->title 		= $js_options->get_option('jigoshop_skrill_title');
		$this->email 		= $js_options->get_option('jigoshop_skrill_email');
    	...
    	<tr>
	        ...
	        <td class="forminp">
		        <select name="jigoshop_skrill_enabled" id="jigoshop_skrill_enabled" style="min-width:100px;">
		            <option value="yes" <?php if ($js_options->get_option('jigoshop_skrill_enabled') == 'yes') echo 'selected="selected"'; ?>><?php _e('Yes', 'jigoshop'); ?></option>
		            <option value="no" <?php if ($js_options->get_option('jigoshop_skrill_enabled') == 'no') echo 'selected="selected"'; ?>><?php _e('No', 'jigoshop'); ?></option>
		        </select>
	        </td>
	    </tr>
	    <tr>
	        ...
	        <td class="forminp">
		        <input class="input-text" type="text" name="jigoshop_skrill_title" id="jigoshop_skrill_title" style="min-width:50px;" value="<?php if ($value = $js_options->get_option('jigoshop_skrill_title')) echo $value; else echo 'skrill'; ?>" />
	        </td>
	    </tr>
	    <tr>
	        ...
	        <td class="forminp">
		        <input class="input-text" type="text" name="jigoshop_skrill_email" id="jigoshop_skrill_email" style="min-width:50px;" value="<?php if ($value = $js_options->get_option('jigoshop_skrill_email')) echo $value; ?>" />
	        </td>
	    </tr>
	    <tr>
	        ...
	        <td class="forminp">
		        <input class="input-text" type="text" name="jigoshop_skrill_secret_word" id="jigoshop_skrill_secret_word" style="min-width:50px;" value="<?php if ($value = $js_options->get_option('jigoshop_skrill_secret_word')) echo $value; ?>" />
	        </td>
	    </tr>
	    <tr>
	        ...
	        <td class="forminp">
		        <input class="input-text" type="text" name="jigoshop_skrill_customer_id" id="jigoshop_skrill_customer_id" style="min-width:50px;" value="<?php if ($value = $js_options->get_option('jigoshop_skrill_customer_id')) echo $value; ?>" />
	        </td>
	    </tr>
    	<?php
    }
    ...
    public function process_admin_options() {
   		if(isset($_POST['jigoshop_skrill_enabled'])) $js_options->set_option('jigoshop_skrill_enabled', jigowatt_clean($_POST['jigoshop_skrill_enabled'])); else $js_options->delete_option('jigoshop_skrill_enabled');
   		if(isset($_POST['jigoshop_skrill_title'])) $js_options->set_option('jigoshop_skrill_title', jigowatt_clean($_POST['jigoshop_skrill_title'])); else $js_options->delete_option('jigoshop_skrill_title');
   		if(isset($_POST['jigoshop_skrill_email'])) $js_options->set_option('jigoshop_skrill_email', jigowatt_clean($_POST['jigoshop_skrill_email'])); else $js_options->delete_option('jigoshop_skrill_email');
   		if(isset($_POST['jigoshop_skrill_secret_word'])) $js_options->set_option('jigoshop_skrill_secret_word', jigowatt_clean($_POST['jigoshop_skrill_secret_word'])); else $js_options->delete_option('jigoshop_skrill_secret_word');
   		if(isset($_POST['jigoshop_skrill_customer_id'])) $js_options->set_option('jigoshop_skrill_customer_id', jigowatt_clean($_POST['jigoshop_skrill_customer_id'])); else $js_options->delete_option('jigoshop_skrill_customer_id');
    }
    ...
    public function generate_skrill_form() {
		...
		$skrill_args = array(
			...
			'amount' => $order_total,
			'currency' => $js_options->get_option('jigoshop_currency'),
		...
		$skrill_md = $js_options->get_option('jigoshop_skrill_customer_id') . $skrill_args['transaction_id'] . strtoupper(md5($js_options->get_option('jigoshop_skrill_secret_word'))) . $order_total . $js_options->get_option('jigoshop_currency') . '2';
