...
class skrill extends jigoshop_payment_gateway {
	...
	public function admin_options() {
		...
		$options = array (
			...
			array( 'name'        => __('Skrill (Moneybookers)', 'jigoshop'), 'type' => 'title', 'desc' => __('Skrill works by using an iFrame to submit payment information securely to Moneybookers.', 'jigoshop') ),
    ...
    public function process_admin_options() {
		if(isset($_POST['jigoshop_skrill_enabled']))     update_option('jigoshop_skrill_enabled'    , jigowatt_clean($_POST['jigoshop_skrill_enabled']));     else update_option('jigoshop_skrill_enabled', 'no');
