...
class RecentProducts extends \WP_Widget
{
	...
	public function widget($args, $instance)
	{
		...
		$query_args = array(
			...
			'post_type' => array(Types::PRODUCT, Types\Product\Variable::TYPE),
			'post_status' => 'publish',
			'orderby' => 'date',
			'order' => 'desc',
			'meta_query' => array(
		...
		if (!empty($products)) {
			Render::output('widget/recent_products/widget', array_merge($args, array(
				'title' => $title,
				'products' => $products,
			)));
		}
	...
	public function form($instance)
	{
		...
		Render::output('widget/recent_products/form', array(
