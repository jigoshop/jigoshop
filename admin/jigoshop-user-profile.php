...
function jigoshop_admin_user_profile(WP_User $user){
	...
	wp_enqueue_script('jigoshop-select2', JIGOSHOP_URL.'/assets/js/select2.min.js', array('jquery'));
	wp_enqueue_style('jigoshop-select2', JIGOSHOP_URL.'/assets/css/select2.css');
