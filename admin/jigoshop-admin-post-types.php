    ...
    switch ($column) {
        ...
        case "featured" :
            ...
            if ($product->is_featured())
                echo '<a href="' . $url . '"><img src="' . jigoshop::assets_url() . '/assets/images/success.gif" alt="yes" />';
            else
                echo '<img src="' . jigoshop::assets_url() . '/assets/images/success-off.gif" alt="no" />';
            echo '</a>';
            break;
        case "visibility" :
        ...
        case "is_in_stock" :
            if (!$product->is_type('grouped') && $product->is_in_stock())
                echo '<img src="' . jigoshop::assets_url() . '/assets/images/success.gif" alt="yes" />';
            else
                echo '<span class="na">&ndash;</span>';
            break;
        case "inventory" :
