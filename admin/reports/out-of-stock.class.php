...
class Jigoshop_Report_Out_Of_Stock extends Jigoshop_Report_Stock
{
	public function no_items()
	{
		_e('No out of stock products found.', 'jigoshop');
	}
	...
	public function get_items($current_page, $per_page)
	{
		...
		$stock = absint(max($options->get('jigoshop_notify_no_stock_amount'), 0));

		$query_from = apply_filters('jigoshop_report_out_of_stock_query_from', "FROM {$wpdb->posts} as posts
