/* ===========================================================
 * bootstrap-tooltip.min.js v2.0.3
...
!function(b){
	...
	a.prototype = {constructor: a, init: function(f, e, d){
		...
		var c = this.$element;
		if(c.attr("tip") || typeof(c.attr("data-original-title")) != "string"){
			c.attr("data-original-title", c.attr("tip") || "").removeAttr("tip")
		}
	}, hasContent: function(){
	...
	b.fn.tooltip.defaults = {animation: true, placement: "top", selector: false, template: '<div class="tooltip"><div class="tooltip-arrow"></div><div class="tooltip-inner"></div></div>', trigger: "hover", title: "", delay: 0}
}(window.jQuery);
