...
class flat_rate extends jigoshop_shipping_method {
	...
	public function __construct() {
        ...
        $this->id 			= 'flat_rate';
        $this->enabled		= Jigoshop_Base_Class::get_options()->get_option('jigoshop_flat_rate_enabled');
		$this->title 		= Jigoshop_Base_Class::get_options()->get_option('jigoshop_flat_rate_title');
		$this->availability = Jigoshop_Base_Class::get_options()->get_option('jigoshop_flat_rate_availability');
		$this->countries 	= Jigoshop_Base_Class::get_options()->get_option('jigoshop_flat_rate_countries');
		$this->type 		= Jigoshop_Base_Class::get_options()->get_option('jigoshop_flat_rate_type');
		$this->tax_status	= Jigoshop_Base_Class::get_options()->get_option('jigoshop_flat_rate_tax_status');
		$this->cost 		= Jigoshop_Base_Class::get_options()->get_option('jigoshop_flat_rate_cost');
		$this->fee 			= Jigoshop_Base_Class::get_options()->get_option('jigoshop_flat_rate_handling_fee');
    ...
    public function calculate_shipping() {
    	...
    	if ($this->type=='order') :
			...
			if ( Jigoshop_Base_Class::get_options()->get_option('jigoshop_calc_taxes')=='yes' && $this->tax_status=='taxable' ) :
