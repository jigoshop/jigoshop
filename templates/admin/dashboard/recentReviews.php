...
<div class="inside jigoshop-reviews-widget">
	...
	<ul>
		...
		<li>
			...
			<h4 class="meta"><a href="<?= get_permalink($comment->ID); ?>#comment-<?= $comment->comment_ID; ?>"><?= $comment->post_title; ?></a><?= __(' reviewed by ', 'jigoshop'); ?> <?= strip_tags($comment->comment_author); ?></h4>
