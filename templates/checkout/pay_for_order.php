...
<form id="pay_for_order" method="post">
    <table class="shop_table">
        ...
        <tfoot>
            ...
            if ($options->get_option('jigoshop_tax_after_coupon') == 'yes' && $order->order_discount > 0) : ?>
                <tr class="discount">
            ...
            if (($options->get_option('jigoshop_calc_taxes') == 'yes' && $order->has_compound_tax())
              || ($options->get_option('jigoshop_tax_after_coupon') == 'yes' && $order->order_discount > 0)) :
                ?><tr>
                    <td colspan="2"><?php _e('Subtotal', 'jigoshop'); ?></td>
            ...
            if ($options->get_option('jigoshop_tax_after_coupon') == 'no' && $order->order_discount > 0) : ?><tr class="discount">
                    <td colspan="2"><?php _e('Discount', 'jigoshop'); ?></td>
                    <td>-<?php echo jigoshop_price($order->order_discount); ?></td>
                </tr><?php endif; ?>
            <tr>
