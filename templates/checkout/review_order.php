            ...
            <ul class="payment_methods methods">
                ...
                if ($available_gateways) :
                    ...
                    foreach ($available_gateways as $gateway) :
                        ?>
                        <li>
                            <input type="radio" id="payment_method_<?php echo $gateway->id; ?>" class="input-radio" name="payment_method" value="<?php echo $gateway->id; ?>" <?php if ($gateway->chosen)
        ...
        <div class="form-row">
            ...
            <?php if (get_option('jigoshop_terms_page_id') > 0) : ?>
                <p class="form-row terms">
                    ...
                    <input type="checkbox" class="input-checkbox" name="terms" <?php if (isset($_POST['terms']))
                    echo 'checked="checked"'; ?> id="terms" />
                </p>
            <?php endif; ?>
